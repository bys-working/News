...
//            ),
            ...
            'Application\BjyAuthorize\Provider\Role\ZendDb' => array(
                'table'                 => 'user_role',
...
//            ),
        ...
        'resource_providers' => array(
            'Application\BjyAuthorize\Provider\Resource\ZendDb' => array(
                'table'    => 'resources',
...
//            ),
        ...
        'rule_providers' => array(
            'Application\BjyAuthorize\Provider\Rule\ZendDb' => array(
                    'table'          => 'rule',
                    'id_field'       => 'id',
                    'rule_field'     => 'resource',
                    'role_field'     => 'role',
...
//                    array(array('guest', 'user'), 'route/roles')
//                ),
//
...
//                array('controller' => 'zfcuser', 'action' => 'index', 'roles' => array('guest','user')),
//                array('controller' => 'zfcuser', 'action' => 'login', 'roles' => array('guest')),
//                array('controller' => 'zfcuser', 'action' => 'logout', 'roles' => array('guest', 'user')),
...
//                array('controller' => 'Application\Controller\Index', 'action' => 'index', 'roles' => array('guest', 'user')),
                ...
                //array('controller' => 'image', 'action' => 'upload', 'roles' => array('user')),
...
//                ),
                //array('controller' => 'image', 'roles' => array('guest')),
